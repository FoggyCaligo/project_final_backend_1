    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Redis 기반 auth2 경로
                        .requestMatchers("/api/v1/auth2/login").permitAll()
                        .requestMatchers("/api/v1/auth2/signup").permitAll()
                        .requestMatchers("/api/v1/auth2/check-login-id").permitAll()
                        .requestMatchers("/api/v1/auth2/refresh").permitAll()
                        .requestMatchers("/api/v1/auth2/verify-email").permitAll()
                        .requestMatchers("/api/v1/auth2/resend-verification").permitAll()
                        .requestMatchers("/api/v1/auth2/kakao/**").permitAll()
                        ...
                        .requestMatchers("/api/v1/auth2/me").authenticated()
                        .requestMatchers("/api/v1/auth2/logout").authenticated()
