...
public enum ErrorCode {
    ...
    INVALID_STORAGE_TYPE(HttpStatus.BAD_REQUEST, "지원하지 않는 보관 방식입니다."),
    ...
    VISION_RECOGNITION_NOT_FOUND(HttpStatus.NOT_FOUND, "이미지 인식 요청을 찾을 수 없습니다."),
    ...
    EMAIL_VERIFY_TOKEN_EXPIRED(HttpStatus.BAD_REQUEST, "이메일 인증 토큰이 만료되었습니다."),
