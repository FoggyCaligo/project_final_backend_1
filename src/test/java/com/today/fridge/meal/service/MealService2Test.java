 ...
 * UT-MEAL-3
 * Method: recordMeal
 * Test Name: 식단 기록 정상 저장 테스트
 * Purpose: 사용자의 식단 기록을 저장하고 헬퍼 메서드를 호출하여 영양 정보를 업데이트한다.
 * Input: userId, MealLogRequest
 * Expected Result: Meal 엔티티가 저장되고 updateDayNutrition이 호출된다.
 * Priority: High
 *
 * UT-MEAL-4
 * Method: updatePhysicalMetrics
 * Test Name: 신체 정보 정상 업데이트 테스트
 * Purpose: 사용자의 신체 정보를 업데이트하고 저장한다.
 * Input: userId, PhysicalMetricsRequest
 * Expected Result: 사용자 정보가 업데이트되고 UserRepository에 저장된다.
 * Priority: Medium
 */
